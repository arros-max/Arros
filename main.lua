...
Credits:AddLabel("script karmaxagus")
Credits:AddLabel("Tiktok: no hay")
Credits:AddLabel("dinosaurio")
Credits:AddLabel("agusxkarma")
Credits:AddLabel("☠️👹")
Credits:AddLabel("☠️👹")
Credits:AddLabel("dragonball")
Credits:AddLabel("Karma")
